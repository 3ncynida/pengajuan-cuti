...
<section class="section">
    <div class="detail-card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="info-group">
                        ...
                        <div class="info-item">
                            <strong>Tanggal Mulai:</strong> {{ \Carbon\Carbon::parse($cuti->tanggal_mulai)->format('d/m/Y') }}
                        </div>
                        <div class="info-item">
                            <strong>Tanggal Selesai:</strong> {{ \Carbon\Carbon::parse($cuti->tanggal_selesai)->format('d/m/Y') }}
                        </div>
                        <div class="info-item">
            ...
            <div class="info-group">
                <h5><i class="bi bi-file-earmark"></i> Dokumen Pendukung</h5>
