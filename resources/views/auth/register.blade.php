...
<body>
    <div class="main-container">
        <div class="register-container">
            ...
            <p class="register-subtitle">Please fill in your information to get started</p>
            ...
            <form method="POST" action="{{ route('register.post') }}">
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="{{ route('login') }}" class="text-decoration-none login-link">Login here</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-white" id="errorModalLabel">Registration Failed</h5>
                ...
                <div class="modal-body">
                    @if ($errors->any())
                        <div class="text-center mb-3">
                            ...
                            <h5 class="text-danger">Registration Error</h5>
                        </div>
