                            ...
                            <form method="POST" action="{{ route('cuti.store') }}" enctype="multipart/form-data">
                                    ...
                                    <select class="form-select @error('jenis_cuti') is-invalid @enderror" id="jenis_cuti"
                                        ...
                                        @if (auth()->user()->jenis_kelamin === 'L')
                                            <option value="ayah" {{ old('jenis_cuti') == 'ayah' ? 'selected' : '' }}>
                                                Cuti Ayah ({{ $cutiQuota->cuti_ayah }} hari)
                                            </option>
                                        @endif
                                    </select>
                                    @error('jenis_cuti')
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="file"
                                        ...
                                        id="dokumen_pendukung" name="dokumen_pendukung">
                                    <small class="text-muted">File harus berformat PDF, JPG, JPEG, atau PNG (max
                                        2MB)</small>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bi bi-check2-circle"></i> Ajukan Cuti
                                    </button>
                                </div>
                            </form>
                        </div>
